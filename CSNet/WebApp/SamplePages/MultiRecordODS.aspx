...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:DropDownList ID="CategoryList" runat="server" DataSourceID="CategoryListODS" DataTextField="CategoryName" DataValueField="CategoryID" AppendDataBoundItems="True">
           <asp:ListItem Value="0">select ...</asp:ListItem>     <%--prompt for ddl--%> 
        </asp:DropDownList>
        &nbsp;&nbsp;
              ...
              <Columns>
                ...
                <asp:TemplateField HeaderText="Supplier">
                    <ItemTemplate>
                       <%--<asp:Label ID="SupplierID" runat="server" 
                        ...
                        <asp:DropDownList ID="SupplierList" runat="server" DataSourceID="SupplierListODS" DataTextField="CompanyName" DataValueField="SupplierID" Enabled="false" selectedvalue='<%# Eval("SupplierID") %>'><%-- enables = false makes it read only --%>
                ...
                <asp:TemplateField HeaderText="Category">
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="CategoryListGV" runat="server" DataSourceID="CategoryListODS" DataTextField="CategoryName" DataValueField="CategoryID" Enabled="false" selectedvalue='<%# Eval("CategoryID") %>'></asp:DropDownList>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="CategoryListODS" runat="server" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="Category_List" TypeName="NorthwindSystem.BLL.CategoryController">
    </asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ProductListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Product_GetByCategories" TypeName="NorthwindSystem.BLL.ProductController">
        <SelectParameters>
